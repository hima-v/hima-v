...
### 🎯 [ML-Based Pairs Trading System](https://github.com/hima-v/pairs-trading-ml)
...
**Tech:** Python • Scikit-Learn • XGBoost • PostgreSQL  
**Highlights:** 
- ✨ Cointegration analysis for pair selection
- 🎯 PSO optimization achieving 0.93 ROC-AUC
- 📈 42% Sharpe ratio improvement over baseline

---

### 🎵 [Automated Spotify Playlist Manager](https://github.com/hima-v/spotify-automation)
...
**Tech:** Flask • REST APIs • Google Cloud Functions • OAuth 2.0  
**Highlights:**
...
### 📊 [Interactive Learning Platform](https://pgm.kjsieit.com)

> Full-stack React application with real-time data visualization.  
> **Impact:** Serving 500+ students, 30% engagement increase

**Tech:** React • Flask/Django • Chart.js • D3.js • PostgreSQL  
**Highlights:**
- 📱 Cross-platform mobile app using JavaScript Bridge
- 📈 Real-time data visualization for complex datasets
- 🎓 Faculty recognition for improving learning outcomes
...
![OAuth](https://img.shields.io/badge/OAuth_2.0-3C873A?style=flat-square&logo=auth0&logoColor=white)
...
**Finance & Analytics:**  
Statistical arbitrage • Algorithmic trading • Time-series forecasting • Risk modeling
